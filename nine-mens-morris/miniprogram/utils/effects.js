...
class BackgroundParticles {
    ...
    updateThemeColors(theme) {
        ...
        const primaryColor = themes[theme] || themes.cyberpunk;
        this.particleColor = primaryColor;
        this.connectionColor = primaryColor + '1a';
    }
    ...
    draw() {
        ...
        if (this.mouseX > 0 && this.mouseY > 0) {
            ...
            const accentColor = themes[this.lastTheme] || themes.cyberpunk;
...
// 导出模块
module.exports = { ParticleSystem, BackgroundParticles };
